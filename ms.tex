...
% TO CHANGE WITH NEW FIGURE (SCALED DIVERSITY)
%The patch dynamics model, \emph{i.e.} when there
...
% DG
Network approach to spatial landscapes is a major advancement in metacommunity ecology.
- First step to make the concept operational (instrumental perspective) because it accounts for more realistic landscape structures and dispersal kernels.
- The realism comes at a first degree from spatially explicit dispersal instead of the simple island-mainland or global dispersal approaches used previously (e.g. Tilman, Mouquet, Hubbell)
- But dispersal is also spatially explicit over a lattice and it does not make the landscape more realistic
- The fundamental feature is the heterogeneity of dispersal
- We found that the more central nodes are usually more diverse
- They might also contribute more to maintain regional diversity, as they are essential for species to spread throughout the landscape.
- Keystone communities \parencite{Mouquet2013} 
- The comparison between metaco perspectives revealed some interesting results in that respect. 
- The patch vs neutral comparison shows that competitive interactions....
- On the other hand the effect of network topology is much weaker with the ss model. We could even hypothesize it will vanish in the extreme case of niche differentiation (with low overlap for instance) and low mass effect. 
- The neutral versus niche comparison therefore illustrates that very strong unequal competitive interactions could overwhelm the impact of dispersal. 
 
The network approach brings spatial variation in coexistence mechanisms.
- If we take the SS perspective for instance, we find that alpha div. is higher in more central nodes
- Since the environment is constant, it means diversity in these communities must be maintained by a stronger mass effect. 
- It results in spatial variation in the relative importance of ss, mass effect and to a certain extent neutral drift. 
- Because the degree centrality was the best variable explaining diversity (here; Altermat 2012; Desjardins 2012b), we should expect the degree distribution to strongly impact the relative importance of these coexistence mechanisms. 
- For a given set of ecological processes and distribution of species traits, we might expect the coexistence mechanisms to differ from one landscape to another. 

%DG
We introduced this article arguing that neutral theory could be used as an instrument to make predictions. 
- So far we have treated only theoretical models, but we could also envision to parameterize them and simulate real landscapes. 
- The recruitment probabilities defined above could be used as satistical models to fit to empirical data. 
- Prior information could be used to define apriori dispersal kernels  and then fit the model
- Long tradition of this in metapopulation ecology (Hasnki 1998) and now new species distribution models are including dispersal limitations (Boulangeat2012)
- Given the parameterization, one could run neutral models to generate null hypotheses that could be eventually compared to observed distribution. 
- This would make a significant improvement over traditional null models in ecology (Gotelli1996) where there are no interactions and no dispersal limitations.
- In addition, neutral models could be used to predict the consequences of habitat destruction and fragmentation (ref Hubbell PNAS)
- The spatially explicit description of the landscape is a major improvement toward that end, providing much flexibility in the scenarios that could be explored. 
